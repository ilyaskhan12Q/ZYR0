...
export function buildCertificateHTML(opts: CertificateTemplateOptions): string {
  ...
  const css = `
    * { box-sizing: border-box; }
    ...
    .body-text .internship-title { font-weight: 900; font-size: 15.5px; color: #13100d; text-decoration: underline; text-decoration-thickness: 2px; text-underline-offset: 3px; text-decoration-color: #b89c56; }
