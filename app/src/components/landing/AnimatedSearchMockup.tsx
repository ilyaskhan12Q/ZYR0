...
export default function AnimatedSearchMockup() {
  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      {/* Search panel */}
      <div className="glass-card-v3 relative z-10 p-5 sm:p-6 text-white">
        <div className="flex items-center justify-between">
          <span className="font-label text-[9px] text-slate-400">
            Explore Internships
          </span>
        ...
        {/* Search input mock */}
        <div className="mt-4 flex items-center gap-3 rounded-2xl border border-white/15 bg-slate-900/80 px-4 py-3.5">
          <Search className="w-4.5 h-4.5 shrink-0 text-sky-400" />
