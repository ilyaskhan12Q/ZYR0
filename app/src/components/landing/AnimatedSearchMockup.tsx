...
export default function AnimatedSearchMockup() {
  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      <div className="absolute -top-5 -left-3 sm:-left-6 z-20 flex items-center gap-2 rounded-full border border-white/15 bg-slate-950/90 backdrop-blur-xl px-3.5 py-1.5 shadow-xl">
      ...
      <div className="glass-card-v3 relative z-10 p-5 sm:p-6 text-slate-900 dark:text-white">
        ...
        <div className="mt-4 flex items-center gap-3 rounded-2xl border border-slate-200 dark:border-white/15 bg-white/80 dark:bg-slate-900/80 px-4 py-3.5">
          ...
          <span className="truncate text-sm font-medium text-slate-700 dark:text-slate-200">
            {typed}
            <span className="ml-0.5 inline-block w-0.5 h-4 bg-blue-600 dark:bg-sky-400 align-middle animate-pulse" />
          </span>
        </div>
          ...
          {PLACES.map((place, i) => (
            <span
              ...
              className={`chip-v3 transition-all duration-300 ${
                i === placeIdx
                  ? 'border-blue-600/40 dark:border-sky-400/50 bg-blue-600/10 dark:bg-sky-400/10 text-blue-700 dark:text-sky-300'
        ...
        <button
          type="button"
          className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-sky-400 dark:to-indigo-500 px-6 py-3 font-display font-semibold text-white text-sm shadow-lg shadow-blue-600/25 dark:shadow-sky-500/20 transition-transform hover:scale-[1.02] active:scale-[0.98]"
        >
          Find Internships
      ...
      <div className="absolute -bottom-5 -right-3 sm:-right-6 z-20 flex items-center gap-2 rounded-full border border-white/15 bg-slate-950/90 backdrop-blur-xl px-3.5 py-1.5 shadow-xl">
