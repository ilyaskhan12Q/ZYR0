  ...
  return (
    <section className="py-14 lg:py-20 px-4 bg-transparent content-visibility-auto">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-center font-display font-bold text-3xl sm:text-4xl lg:text-5xl tracking-tight text-slate-900 dark:text-white">
          Roles companies are <span className="font-accent text-blue-600 dark:text-sky-400">hiring for</span>
        </h2>
