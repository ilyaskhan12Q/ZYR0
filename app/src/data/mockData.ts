...
export const users: User[] = [
  ...
  { id: '8', name: 'Admin User', email: 'admin@zyroo.org', avatar: 'https://i.pravatar.cc/150?u=admin', role: 'admin', status: 'active', joinDate: '2024-01-01', lastActive: '2025-01-20T12:00:00Z' },
];
