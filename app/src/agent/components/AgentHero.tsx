    ...
    <>
      ...
      {isOpen && createPortal(
        <>
          ...
          <div
            className="fixed z-[9999] w-[260px] max-h-[320px] overflow-y-auto bg-[#1a1a1e]/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl shadow-black/50 animate-in fade-in slide-in-from-top-2 duration-150"
